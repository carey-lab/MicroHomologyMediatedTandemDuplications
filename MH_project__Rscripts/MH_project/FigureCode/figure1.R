...
count <- type_MHkb[-match("chromosome",type_MHkb$types),4]
names(count) <- type_MHkb[-match("chromosome",type_MHkb$types),1]
...
fre_fre <- log2(count/(1000*sum(type_MHkb[-match("chromosome",type_MHkb$types),2])/nt_wg))
names(count) <- type_MHkb[-match("chromosome",type_MHkb$types),1]
